...
inline ParsedDType parse_data_type(const std::string& text, const std::string& ctx) {
...
inline std::string emit_data_type(DataType dt, bool big_endian) {
...
inline json emit_group_meta() { return json{{"zarr_format", 2}}; }
